...
class GlotPress {
	 ...
	 * @since    0.1
	 * @access   protected
	 * @var      GlotPress_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - GlotPress_Loader. Orchestrates the hooks of the plugin.
	 * - GlotPress_i18n. Defines internationalization functionality.
	 * - GlotPress_Admin. Defines all hooks for the admin area.
	 * - GlotPress_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-glotpress-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'routes/base-route.php';
	 ...
	 *
	 * Uses the GlotPress_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    0.1
	 * @access   private
	 ...
	 *
	 * @since     0.1
	 * @return    GlotPress_Loader    Orchestrates the hooks of the plugin.
	 */
